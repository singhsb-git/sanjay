 ...
 * and conquer algorithm. Quicksort first divides a large list into two smaller sub-lists: the 
 * low elements and the high elements. Quicksort can then recursively sort the sub-lists.
